...
class ItemCardComponentPreview < ViewComponent::Preview
  ...
  def with_image
    item = Item.new(
      ...
      link_url: 'https://www.amazon.co.jp/exec/obidos/ASIN/B0EXAMPLE/vkdb-22/',
      artists: [
  ...
  def without_image
    item = Item.new(
      ...
      image_url: nil,
      link_url: 'https://www.amazon.co.jp/exec/obidos/ASIN/B0EXAMPLE2/vkdb-22/',
      artists: [
  ...
  def multiple_artists
    item = Item.new(
      ...
      link_url: 'https://www.amazon.co.jp/exec/obidos/ASIN/B0EXAMPLE3/vkdb-22/',
      artists: [
        { 'name' => 'lynch.', 'old_key' => '%A5%EA%A5%F3%A5%C1' },
        { 'name' => 'DIR EN GREY', 'old_key' => '%A5%C7%A5%A3%A5%EB%A5%A2%A5%F3%A5%B0%A5%EC%A5%A4' },
  ...
  def artist_without_old_key
    item = Item.new(
      ...
      link_url: 'https://www.amazon.co.jp/exec/obidos/ASIN/B0EXAMPLE4/vkdb-22/',
      artists: [
        { 'name' => 'New Artist' }
      ]
    )
