...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'www.vkdb.jp' }

  # Send mail via Gmail SMTP (issue #1560). Low volume, single recipient (admin
  # notifications), so Gmail's free sending limit is not a concern. Requires
  # 2-step verification + an app password on the Gmail account; add via
