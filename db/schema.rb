...
ActiveRecord::Schema[8.1].define(version: 2026_09_26_010000) do
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index "((aliases)::text) gin_trgm_ops", name: "index_people_on_aliases_trgm", using: :gin
    t.index "((name_log)::text) gin_trgm_ops", name: "index_people_on_name_log_trgm", using: :gin
  ...
  create_table "update_logs", force: :cascade do |t|
    ...
    t.index ["subject_type", "created_at"], name: "index_update_logs_on_subject_type_and_created_at"
    t.index ["subject_type", "subject_id"], name: "index_update_logs_on_subject_type_and_subject_id"
